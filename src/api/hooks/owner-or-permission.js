...
module.exports = function ownerOrPermission({ service, permission }) {
  ...
  return [
    ...
    unless(
      isUserOwner({ service }),
      unless(hasPermissionBoolean(permission), (hook) => {
        ...
        return Promise.reject(
          new errors.Forbidden(
            `${name} is neither the owner nor has the permission to edit this message.`
          )
        );
      })
    ),
